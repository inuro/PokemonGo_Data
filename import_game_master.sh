...
M.duration,
M.energy_gain,
(CASE WHEN P.type1 = M.type OR P.type2 = M.type THEN 1.25 ELSE 1.0 END)::double precision as STAB,
(0.5*M.power*P.at*(CASE WHEN P.type1 = M.type OR P.type2 = M.type THEN 1.25 ELSE 1.0 END))::double precision as firepower
