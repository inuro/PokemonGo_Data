...
# [usage]
# $ pokemon_ranking_v2.sh [-l limit] [-t target_pokemon_name_jp] [-f target_fastmove_jp][-c target_chargemove_jp] [-d chargemove_dodge]　[-s Sort]
# $ ./pokemon_ranking_v2.sh -l 100 -t バンギラス -f かみつく -c ストーンエッジ
...
WHERE true
$MEONLY
--and ROUND((TotalDPS - AVRG) / STDRD * 10 + 50, 1) > 65.0
--and killtime < 99.9
